...
import com.alphashop.Application;
import com.alphashop.repositories.UserRepository;
...
public class UserControllerTest 
{
	...
	{
		mockMvc.perform(MockMvcRequestBuilders.get("/api/user/find/userid/mario")
				.accept(MediaType.APPLICATION_JSON))
				...
				assertThat(passwordEncoder.matches("pass123", 
						userRepository.findByUserId("mario").getPassword()))
				.isEqualTo(true);
	}
	...
	{
		mockMvc.perform(MockMvcRequestBuilders.get("/api/user/find/all")
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())
	...
	{
		mockMvc.perform(MockMvcRequestBuilders.delete("/api/user/delete/mario")
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())
