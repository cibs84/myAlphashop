...
public class CustomUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		log.warning("Carica loadUserByUsername() nella classe CustomUserDetailsService");
		String errMsg = "";
		
		if (username == null || username.length() < 5) {
			errMsg = "Inserire uno Username valido!";
			log.warning(errMsg);
	...
	private User httpGetUserByUserId(String userId) {
		...
		try {
            ...
            String ErrMsg = "Connectiom to authentication service failed or service absent!";
            log.warning(ErrMsg);
        }
